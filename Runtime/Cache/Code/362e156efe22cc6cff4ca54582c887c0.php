        ...
        <div class="list item">
          ...
          <table class="layui-table" lay-data="{width:'100%',limit:<?php echo ($rows); ?>,id:'userData'}">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                  <button  class="layui-btn layui-btn-small" onclick="order_view('系统订单号:<?php echo ($vo["pay_orderid"]); ?>','<?php echo U('Agent/Ordershow',['oid'=>$vo[id]]);?>',400)">订单详情</button>
                 
                  <?php if(($vo["pay_status"]) == "0"): ?><button  class="layui-btn layui-btn-small layui-btn-danger" onclick="setOrderPaid('设置订单为已支付','<?php echo U('Agent/setOrderPaid',['orderid'=>$vo[id]]);?>',400)">确认到账</button><?php endif; ?>
