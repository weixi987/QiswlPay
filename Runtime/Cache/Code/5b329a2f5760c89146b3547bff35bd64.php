  ...
  <div class="col-md-12">
    <div class="ibox float-e-margins">
      <div class="ibox-title">
        <h5 style="margin:0">码商名称：<?php echo ($fans["username"]); ?></h5><h5>&nbsp;&nbsp;码商ID：<?php echo ($fans["memberid"]); ?></h5>
      </div>
...
<div class="row zuy-nav">
  ...
  <div class="row zuy-nav">
      ...
      <div class="col-sm-3" style="height: 140px">
        <div class="ibox float-e-margins">
          <div class="ibox-title">
            <h5><?php echo ($stat["coderatemoney"]); ?></h5>
          </div>
          <div class="ibox-content" style="">
            <h1 class="no-margins">今日佣金（元）</h1>
    ...
    <div class="col-sm-3">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          ...
          <small>账户可用额度<?php echo ($fans['balance']); ?></small>
        </div>
      </div>
    </div>
    <div class="col-sm-3">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5><?php echo ($fans['codeblockedbalance']); ?></h5>
        </div>
        <div class="ibox-content">
