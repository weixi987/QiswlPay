...
<html lang="en">
  ...
  <!-- begin::Body -->
  <body style="background-image: url(Public/Qiswl/assets4/app/media/img/bg/bg-1.jpg)" class="m-page--boxed m-body--fixed m-header--static m-aside--offcanvas-default">
                            ...
                            <div class="m-card-user m-card-user--skin-dark">
                              ...
                              <div class="m-card-user__details">
                                ...
                                <a href="" class="m-card-user__email m--font-weight-300 m-link">
                                  <?php if(($fans[groupid]) == "5"): ?>代理<?php endif; ?> 
                                  <?php if(($fans[groupid]) == "6"): ?>中级代理<?php endif; ?> 
                                 <?php if(($fans[groupid]) == "7"): ?>高级代理<?php endif; ?> 
                                  <?php if(($fans[groupid]) == "4"): ?>个人商户<?php endif; ?>
                                </a>
                              </div>
                            </div>
                          </div>
                              ...
                              <ul class="m-nav m-nav--skin-light">
                                  ...
                                  <a href="#" class="m-nav__link">
                                    ...
                                    <span class="m-nav__link-title">
                                      <span class="m-nav__link-wrap">
                                        ...
                                        <span class="m-nav__link-badge"><span class="m-badge m-badge--info m-badge--wide"><?php echo ($fans['blockedbalance']); ?></span></span>
                                      </span>
                                    </span>
                                  </a>
                                </li>
                                <li class="m-nav__item">
                                  <a href="#" class="m-nav__link">
                                    ...
                                    <span class="m-nav__link-title">
                                      <span class="m-nav__link-wrap">
                                        <span class="m-nav__link-text">投诉保证金</span>
                                        <span class="m-nav__link-badge"><span class="m-badge m-badge--danger m-badge--wide"><?php echo ($fans['balance']); ?></span></span>
                                      </span>
                                    </span>
                                  </a>
                                </li>
        ...
        <div class="m-stack__item m-stack__item--middle m-stack__item--fluid">
            ...
            <div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-light m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light ">
                <ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
                    ...
                    <li class="m-menu__item  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="m-menu__link m-menu__toggle" title="Non functional dummy link"><span class="m-menu__item-here"></span><span class="m-menu__link-text">账户管理</span><i class="m-menu__hor-arrow la la-angle-down"></i><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                        <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
                            <ul class="m-menu__subnav">
                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Account/profile");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">基本信息</span></a></li>
                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Account/bankcard");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">银行卡管理</span></a></li>
                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Account/authorized");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">认证信息</span></a></li>
                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Account/editPassword");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">登录密码</span></a></li>
                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Account/editPaypassword");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">支付密码</span></a></li>
                                ...
                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Account/google");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">Google身份验证</span></a></li>
                            </ul>
                        </div>
                    </li>
                    <?php if(($fans[can_sh]) == "1"): ?><li class="m-menu__item   " aria-haspopup="true">
                    ...
                    <li class="m-menu__item  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="m-menu__link m-menu__toggle" title="Non functional dummy link"><span class="m-menu__item-here"></span><span class="m-menu__link-text">财务管理</span><i class="m-menu__hor-arrow la la-angle-down"></i><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                        <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
                            <ul class="m-menu__subnav">
                                ...
                                <?php if(($fans[groupid]) == "4"): ?><li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Account/channelFinance");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">通道分析</span></a></li><?php endif; ?>
                                <?php if(($fans[groupid]) != "4"): ?><li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Account/agChannelFinance");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">通道分析</span></a></li><?php endif; ?>
                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Account/complaintsDeposit");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">证金明细</span></a></li>
                                ...
                                <?php if(($fans[groupid]) == "4"): ?><li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Account/reconciliation");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">商户对账单</span></a></li><?php endif; ?>
                    ...
                    <li class="m-menu__item  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="m-menu__link m-menu__toggle" title="Non functional dummy link"><span class="m-menu__item-here"></span><span class="m-menu__link-text">资金管理</span><i class="m-menu__hor-arrow la la-angle-down"></i><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                        <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
                            <ul class="m-menu__subnav">
                                ...
                                <?php if($siteconfig['payingservice']): ?><li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Withdrawal/dfapply");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">申请代付</span></a></li><?php endif; ?>
                                ...
                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Withdrawal/payment");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">代付记录</span></a></li>
                                <?php if($siteconfig['df_api'] and $fans[df_api]): ?><li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Withdrawal/check");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">商户代付管理</span></a></li><?php endif; ?>
                    ...
                    <li class="m-menu__item  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="m-menu__link m-menu__toggle" title="Non functional dummy link"><span class="m-menu__item-here"></span><span class="m-menu__link-text">订单管理</span><i class="m-menu__hor-arrow la la-angle-down"></i><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                        <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
                            <ul class="m-menu__subnav">
                                <?php if(($fans[groupid]) != "4"): ?><li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Agent/order");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">所有订单</span></a></li><?php endif; ?>
                                <?php if(($fans[groupid]) == "4"): ?><li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Order/index");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">所有订单</span></a></li>
                                    ...
                                    <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Order/index",['status'=>0]);?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">未支付订单</span></a></li><?php endif; ?>
                               
                            </ul>
                        </div>
                    </li>
                    <?php if(($fans[groupid]) != "4"): ?><li class="m-menu__item  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="m-menu__link m-menu__toggle" title="Non functional dummy link"><span class="m-menu__item-here"></span><span class="m-menu__link-text">代理管理</span><i class="m-menu__hor-arrow la la-angle-down"></i><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                            <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
                                <ul class="m-menu__subnav">
                                    ...
                                    <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Agent/member");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">下级商户管理</span></a></li>
                    ...
                    <?php if(($fans[can_sh]) == "1"): ?><li class="m-menu__item  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="m-menu__link m-menu__toggle" title="Non functional dummy link"><span class="m-menu__item-here"></span><span class="m-menu__link-text">通道管理</span><i class="m-menu__hor-arrow la la-angle-down"></i><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                            <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
                                <ul class="m-menu__subnav">

                                    <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Agent/duizhangdan");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">代理对账单</span></a></li>
                                    
                                    <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Statistics/index");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">接口交易统计</span></a></li>
                                </ul>
                            </div>
                        </li><?php endif; ?>
                            ...
                            <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
                                <ul class="m-menu__subnav">
                                    <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Channel/index");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">查看通道费率</span></a></li>
                                        ...
                                        <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:MenuChange('<?php echo U("Channel/apidocumnet");?>');" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">API开发文档</span></a></li>
