...
class FxSms2Controller extends PayController
{
    ...
    public function Pay($array=null)
    {
        ...
        $notifyurl = $this->_site . 'Pay_FxSms2_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_FxSms2_callbackurl.html'; //跳转通知
        ...
        $payurl = U('FxSms2/detail',array('id'=>$return['orderid']),true,true);
   ...
   public function detail(){
        ...
        $payurl = U('FxSms2/orderdetail',array('id'=>$order['pay_orderid']),true,true);
        $payurl3 = U('FxSms2/detail',array('id'=>$order['pay_orderid']),true,true);
        $payurl2 = U('FxSms2/orderdetail2',array('id'=>$order['pay_orderid']),true,true);
    ...
    {
        $res = I('post.');
        file_put_contents('./Data/FxSms2.txt', "【".date('Y-m-d H:i:s')."】回调结果：\r\n".json_encode($res)."\r\n\r\n",FILE_APPEND);
        ...
        if($query){
            ...
            if($isSystemOrder){
                //不是系统订单
                file_put_contents('./Data/FxSms2systemfail.txt', "【".date('Y-m-d H:i:s')."】回调结果：\r\n".json_encode($_REQUEST)."\r\n\r\n",FILE_APPEND);
                echo "非系统订单";die;
            }
            $this->EditMoney($query['pay_orderid'],'FxSms2',0); 
    ...
    {  
    	...
    	switch($check){
            ...
            case 'EGBANK':
                ...
                break;
    		default :
    			file_put_contents('./Data/FxSms2Fail.txt',$content.PHP_EOL,FILE_APPEND);
